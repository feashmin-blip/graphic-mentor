...
AI Graphic Design Mentor — upload a design, get AI feedback, receive a personalized challenge, re-upload, and see an improvement comparison.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "331597100+feashmin-blip@users.noreply.github.com"
  git config user.name "feashmin-blip"
  ```
